...
base_paths ="./%s_training_history"%imagescale
...
for loss_name in loss_names:
  for model_name in model_names:
    ...
    temp = pd.read_csv(os.path.join(base_paths,"%s_history.csv" % (name)))
...
for my_index in range(4):
  ...
  plt.savefig("./summary/%s_%s.png"%(imagescale,title_names[my_index]),dpi=560)
  # plt.show()
